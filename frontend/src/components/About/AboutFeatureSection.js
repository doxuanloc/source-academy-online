        ...
        <div className="row">
          <div className="col-12">
            <div className="section-title text-center mb-60">
              <h1>
                Chiến Lược Của Nau Pha Che
                <br />
                Học Viện <span className="down-mark-line-2">Pha Chế</span>
              </h1>
            </div>
          </div>
          <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
            <div className="features-box text-center mb-30">
              ...
              <div className="features-text">
                <h4>Những Video Pha Chế Chất Lương</h4>
                <p>
                  Với nhiều năm kinh nghiệm chúng tôi am hiểu thị trường, là đối
                  tác cung cấp nguyên liệu, giải pháp cho các thương hiệu trà
                  sữa hàng đầu như: Heytea,Royaltea, Yihekaonai, Phúc Tea, Lee
                  Tea…
                </p>
              </div>
            </div>
          ...
          <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
            <div className="features-box text-center mb-30">
              ...
              <div className="features-text">
                <h4>Đào tạo tổng thể</h4>
                <p>
                  Đào tạo tổng thể Nauphache mang đến giải pháp tổng thể dành
                  cho chủ quán, tư vấn thiết kế thi công cửa hàng, setup quầy
                  bar máy móc thiết bị, đào tạo pha chế, đào tạo quản lí vận
                  hành , hỗ trợ khai trương, cung cấp giải pháp marketing tổng
                  thể .
                </p>
              </div>
            </div>
          ...
          <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
            <div className="features-box text-center mb-30">
              ...
              <div className="features-text">
                ...
                <p>
                  Khi có những khóa học chất lượng từ Nau Pha Che, bạn chỉ cần
                  chuẩn bị các nguyên liệu, còn mix nó, để chúng tôi cho bạn
                  những bài giảng xịn xò với công thức pha chế tuyệt đỉnh.
                </p>
              </div>
            </div>
          </div>
